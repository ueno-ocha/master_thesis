...
#thisdir = '/home/mana/GenderBiasMitigation_old/midresults/stereoset'
...
parser.add_argument(
    ...
    #default='/home/mana/GenderBiasMitigation_old/midresults/stereoset',
...
if __name__ == "__main__":
    ...
    if args.predictions_dir is not None:
        ...
        for prediction_file in glob.glob(predictions_dir + "*.json"):
            ...
            parse_file(
                f"{args.persistent_dir}/stereoset/data/stereoset/test.json", prediction_file
            )
    else:
        parse_file(
            f"{args.persistent_dir}/stereoset/data/stereoset/test.json", args.predictions_file
        )